...
namespace Print_Message
{
    public class ManuPrintRecordParam
    {
        ...
        public int CHCheckSnMark { get; set; }


        public int CHCheckSimMark { get; set; }


        public int CHCheckBatMark { get; set; }


        public int CHCheckIccidMark { get; set; }


        public int CHCheckMacMark { get; set; }


        public int CHCheckEquipmentMark { get; set; }


        public int CHCheckVipMark { get; set; }


        public int CHCheckRfidMark { get; set; }


        public int CHCheckImei14Mark { get; set; }
